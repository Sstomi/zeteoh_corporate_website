    ...
    <footer className="bg-Footer-image bg-center bg-no-repeat text-center lg:text-left bg-BG-color">
      <div className="flex justify-center items-center lg:justify-between p-6 border-b border-gray-500">
        <div className="mr-12 hidden lg:block">
          <span className="text-gray-100">{t("footer_message")}</span>
        </div>
        <div className="flex justify-center">
          ...
          <a href="https://github.com/zeteohorg" className="text-gray-100">
            <svg
              aria-hidden="true"
              focusable="false"
              data-prefix="fab"
      ...
      <div className="mx-6 py-10 text-center md:text-left">
        <div className="grid grid-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          <div className="">
            ...
            <p className="mt-4 text-gray-100">{t("title")}</p>
          </div>
          <div className="">
      ...
      <div className="bg-BG-color text-center p-6 text-white">
