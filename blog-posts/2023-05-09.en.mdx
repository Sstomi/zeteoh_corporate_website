...
date: "2023-05-09"
thumbnail: "/images/Blog/2023-0422/RTLS_pros_cons.png"
---

![](/images/Blog/2023-0422/RTLS_pros_cons.png)
...
<ImageWithCaption
  ...
  long_caption="Trilateration: we compute the target's position using the distance between at least three beacons or more and the object to track."
...
Inertial navigation is a self-contained navigation technique in which measurements provided by accelerometers and gyroscopes are used to track the position and orientation of an object relative to a known starting point, direction, and velocity. The great point is that this method doesn't require beacons because it is self-contained. But most systems using inertial navigation are costly or have low accuracy.
...
As we saw in this article, choosing the right technology for your indoor location is a lot of work. The solutions using beacons are usually more accurate but less flexible and require an enormous initial investment. But indoor location systems can benefit your businesses, and many successful cases exist.